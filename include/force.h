...
enum class ForceFormula {PARKHOMCHUK,DERBENEVSKRINSKY,MESHKOV,UNMAGNETIZED,BUDKER,POGORELOV};
...
class Force_Pogorelov : public ForceParas{
    private:
    //Force-dependent constants
        //double f_const = -4 * k_me_kg * pow(k_re*k_c*k_c,2); //for Parkhomchuk
        //const char* test_filename = "Parkhomchuk.txt";
    public:
        Force_Pogorelov():ForceParas(ForceFormula::POGORELOV,-4 * k_me_kg * pow(k_re*k_c*k_c,2),"Pogorelov.txt"){};
